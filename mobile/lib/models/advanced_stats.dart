...
class AdvancedStats {
  ...
  factory AdvancedStats.fromJson(Map<String, dynamic> json) {
    return AdvancedStats(
      ...
      weeklyFilms: json['weekly_films'] as int? ?? 0,
      weeklyMinutes: json['weekly_minutes'] as int? ?? 0,
      monthlyFilms: json['monthly_films'] as int? ?? 0,
      genreDistribution: (json['genre_distribution'] as List?)
              ?.map((g) => GenreStats.fromJson(g as Map<String, dynamic>))
              .toList() ??
          [],
      favoriteMovie: json['favorite_movie'] != null
          ? FavoriteMovie.fromJson(json['favorite_movie'] as Map<String, dynamic>)
          : null,
      favoriteActor: json['favorite_actor'] != null
          ? FavoriteInfo.fromJson(json['favorite_actor'] as Map<String, dynamic>)
          : null,
      favoriteCountry: json['favorite_country'] != null
          ? FavoriteInfo.fromJson(json['favorite_country'] as Map<String, dynamic>)
          : null,
    );
  }
}
...
class FavoriteMovie {
  ...
  factory FavoriteMovie.fromJson(Map<String, dynamic> json) {
    ...
    final rawPoster = json['poster_path'] as String? ?? json['poster'] as String? ?? '';
